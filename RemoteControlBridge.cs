...
namespace ClaudeBuddy
{
    ...
    internal sealed class RemoteControlBridge : IDisposable
    {
        ...
        // lowercased, plus a short suffix — `~` gives `user-9b`,
        ...
        //
        //     cwd .../rc-cwd/claude-buddy-rc--claude-board-hostmbp
        //       → "This session is claude-buddy-rc--claude-board-hostmbp-43"
        //
        ...
        // `user-9b`, IsOwnRelay never matches it (so a dead one
        ...
        // routinely contains both ("host-MacBook-Pro.local").
        ...
        internal static string MachineTag(string? name)
        {
            ...
            // perfectly ordinary "host-MacBook-Pro.local" truncates to
            // "host-macbook-prol".
