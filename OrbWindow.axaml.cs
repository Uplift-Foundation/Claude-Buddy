...
namespace ClaudeBuddy
{
    public partial class OrbWindow : Window
    {
        ...
        // "Aurora — wtvamp" split into three tokens and Initial() dropped the
        // lone dash — but "Aurora—wtvamp" was one word and gave "Li". Both
        // give "Lw" now.
        //
        ...
        private static string GlyphFor(string label)
        {
            ...
            // "Aurora — wtvamp" splits into three tokens, the middle one a
