...
#pragma warning disable CA1416
    public class WindowsProcessScanTests
    {
        ...
        // the marker exists.
        [Theory]
        [InlineData(@"C:\Users\user\.local\bin\claude.exe")]
        ...
        public void AnUnquotedProfileDirectoryIsRead()
        {
            var instance = WindowsProcessScan.MapRow(
                Packaged, @"--user-data-dir=C:\Users\user\AppData\Roaming\Claude-work", 7);

            Assert.Equal(@"C:\Users\user\AppData\Roaming\Claude-work", instance!.Value.UserDataDir);
        }
        ...
        {
            var instance = WindowsProcessScan.MapRow(
                Packaged, @"--user-data-dir=""C:\Users\user\Application Support\Claude""", 7);

            Assert.Equal(@"C:\Users\user\Application Support\Claude", instance!.Value.UserDataDir);
        }
