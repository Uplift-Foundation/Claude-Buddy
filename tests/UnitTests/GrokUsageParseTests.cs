...
public class GrokUsageParseTests
{
    ...
    public void ALiveCreditsLineBecomesAWeeklyWindowAndNoFiveHourRing()
    {
        var usage = GrokUsageParse.FromCreditsConfig(
            LiveConfig, "/Users/w/.grok", "user", DateTimeOffset.Parse("2026-08-31T18:00:00Z"));
    ...
    {
        var json = """{"https://auth.x.ai::id": {"email": "user@example.com"}}""";
        Assert.Equal("user", GrokUsageAccounts.LabelFrom(json, "/tmp/.grok-work"));
    }
    ...
    {
        var usage = GrokUsageParse.FromCreditsConfig(
            LiveLogLine, "/Users/w/.grok", "user", DateTimeOffset.Parse("2026-09-01T06:00:00Z"));
