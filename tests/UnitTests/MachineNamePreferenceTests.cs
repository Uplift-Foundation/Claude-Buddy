...
// recognise. macOS's own name for that machine is "the host Mac mini".
//
...
public class MachineNamePreferenceTests
{
    ...
    public void LocalHostNameIsPreferred()
    {
        ...
        Assert.Equal(
            ...
            MachineNames.Preferred(
                Answers(("LocalHostName", "host-mac-mini"), ("ComputerName", "the owner’s Mac mini")),
                () => "avatar"));
    }
    ...
    public void ComputerNameIsUsedWhenThereIsNoLocalHostName()
    {
        ...
        Assert.Equal(
            "the owner’s Mac mini",
            MachineNames.Preferred(
                Answers(("ComputerName", "the owner’s Mac mini")), () => "avatar"));
    }
    ...
    public void AnEmptyAnswerIsNotAnAnswer(string? blank)
    {
        ...
        Assert.Equal(
            "the owner’s Mac mini",
            MachineNames.Preferred(
                Answers(("LocalHostName", blank), ("ComputerName", "the owner’s Mac mini")),
                () => "avatar"));
    }
    ...
    public void ALocalHostNameSurvivesIntactApartFromCase()
    {
        ...
        Assert.Equal("host-mac-mini", MachineNames.Tag("host-mac-mini"));
    }
    ...
    public void TheNameOnTheWireKeepsItsCaseAndHyphens()
    {
        ...
        Assert.Equal("host-mac-mini", MachineNames.Clean("host-mac-mini"));
    }
