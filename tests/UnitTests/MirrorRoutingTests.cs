...
public class MirrorRoutingTests
{
    ...
    [Theory]
    [InlineData("host-MacBook-Pro.local", "host-macbook-pro")]
    ...
    public void EveryRelayThisAppHasEverLaunchedIsRecognised()
    {
        ...
        Assert.True(RemoteControlBridge.IsOwnRelayName(
            "claude-buddy-rc--claude-host-mbp"));
        ...
        Assert.True(RemoteControlBridge.IsOwnRelayName(
            "claude-buddy-rc--claude-t1-host-mbp"));
    ...
    [InlineData("user-9b")]          // the measured non-prefixed shape
    ...
    public void ARelaysStatusFileIsRecognisedByItsCwd()
    {
        Assert.True(RemoteControlBridge.IsOwnRelayCwd(
            "/Users/w/Library/Application Support/ClaudeBuddy/rc-cwd/claude-buddy-rc--claude-host-mbp"));
        ...
        Assert.True(RemoteControlBridge.IsOwnRelayCwd(
            "/Users/w/rc-cwd/claude-buddy-rc--claude-host-mbp/"));
    }

    [Theory]
    [InlineData("/Users/user/Source/Claude-Buddy")]
    ...
    [InlineData("claude-buddy-rc--claude-host-mbp", ".claude", "host-mbp")]
    [InlineData("claude-buddy-rc--claude-board-host-mbp", ".claude-board", "host-mbp")]
    ...
    {
        var machine = RemoteControlBridge.MachineTag("host-MacBook-Pro.local");
