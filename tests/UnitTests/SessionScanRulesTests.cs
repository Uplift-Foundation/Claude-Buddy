...
public class SessionScanRulesTests
{
    ...
    [Theory]
    [InlineData("/Users/user/project/", "/Users/user/project")]
    [InlineData(@"C:\Users\user\project\", @"C:\Users\user\project")]
    [InlineData("/Users/user/project", "/Users/user/project")]
    [InlineData("", "")]
    ...
    {
        var codex = new SessionStatus { Source = SessionSource.Codex, Cwd = "/Users/user/project" };
        var claude = new SessionStatus { Source = SessionSource.ClaudeCode, Cwd = "/Users/user/project" };

        Assert.Equal("codex\n/Users/user/project", SessionManager.PositionKeyFor(codex, "id-1"));
        Assert.Equal("/Users/user/project", SessionManager.PositionKeyFor(claude, "id-2"));
    }
    ...
    public void PositionKeyFor_AppendsTitleWhenPresentAndOmitsItWhenEmpty()
    {
        ...
        {
            Source = SessionSource.ClaudeCode, Cwd = "/Users/user/evidence", Title = "job-lawyer"
        };
        var untitled = new SessionStatus
        {
            Source = SessionSource.ClaudeCode, Cwd = "/Users/user/evidence", Title = ""
        };

        Assert.Equal("/Users/user/evidence\njob-lawyer", SessionManager.PositionKeyFor(titled, "id-1"));
        Assert.Equal("/Users/user/evidence", SessionManager.PositionKeyFor(untitled, "id-2"));
    }
    ...
    [InlineData("Aurora — general", "general")]
    [InlineData("Nova — dev ops", "dev ops")]
    // An em dash with no spaces around it is part of a name, not a separator.
    [InlineData("Aurora—general", "Aurora—general")]
