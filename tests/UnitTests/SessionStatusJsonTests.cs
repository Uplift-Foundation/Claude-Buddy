...
public class SessionStatusJsonTests
{
    ...
    private const string HookProducedJson =
        "{\"state\":\"generating\",\"cli\":\"codex\",\"cwd\":\"/Users/user/project\"," +
        ...
        "\"session_pid\":12345,\"transcript_path\":\"/Users/user/.codex/sessions/2026/08/21/rollout.jsonl\"}";
    ...
    public void Deserialize_MapsEveryHookWrittenFieldOntoItsProperty()
    {
        ...
        Assert.Equal("/Users/user/project", status.Cwd);
        ...
        Assert.Equal("/Users/user/.codex/sessions/2026/08/21/rollout.jsonl", status.TranscriptPath);
