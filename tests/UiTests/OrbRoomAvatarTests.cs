...
public class OrbRoomAvatarTests
{
    ...
    public void ARoomWithTwoPicturedMembersWearsBothOfThem()
    {
        try
        {
            ...
            Publish((nova, Png(0xE0, 0x20, 0x20)), (annabel, Png(0x20, 0x20, 0xE0)));
            Standing(room, nova, annabel);
    ...
    public void AMemberWithNoPictureStillTakesAWedge()
    {
        try
        {
            ...
            Publish((nova, Png(0xE0, 0x20, 0x20)), (quiet, null));
            Standing(room, nova, quiet);
    ...
    public void SomebodyJoiningRecutsThePie()
    {
        try
        {
            ...
            Standing(room, nova, annabel, amber);
