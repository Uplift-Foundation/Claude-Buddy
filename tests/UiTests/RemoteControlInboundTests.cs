...
public class RemoteControlInboundTests
{
    ...
    private static BridgeProtocol.InboundMessage Message(string body, string from = "nova") =>
    ...
    public void AnInfoReplysColourIsRemembered()
    {
        ...
        Assert.Equal("#ff0000", RemoteControlSessions.ColourFor(Account, "nova"));
    }
    ...
    public void ColoursAreRememberedPerAccountNotJustPerName()
    {
        ...
        Assert.Equal("#ff0000", RemoteControlSessions.ColourFor(Account, "nova"));
        Assert.Null(RemoteControlSessions.ColourFor("home@example.com", "nova"));
    }
    ...
    public void AnUnparseableInfoReplyIsStillSwallowed()
    {
        ...
        Assert.Null(RemoteControlSessions.ColourFor(Account, "nova"));
    }
    ...
    public void TheMarkerIsRecognisedWhateverItsCase()
    {
        ...
        Assert.Equal("#00ff00", RemoteControlSessions.ColourFor(Account, "nova"));
    }
    ...
    public void AnInfoReplysCommandsAreRemembered()
    {
        ...
        var commands = RemoteControlSessions.CommandsFor(Account, "nova");
