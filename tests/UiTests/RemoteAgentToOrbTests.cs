...
public class RemoteAgentToOrbTests
{
    ...
    public void ARemoteControlSessionBecomesAnOrb()
    {
        ...
        var remote = Assert.Single(Map(Agent("nova")));

        Assert.Equal("nova", remote.Name);
    ...
    public void ALocalPeerIsNotAnOrb(string kind)
    {
        ...
        Assert.Empty(Map(Agent("nova", kind: kind)));
    }
    ...
    public void AnOfflineSessionIsNotAnOrb()
    {
        ...
        Assert.Empty(Map(Agent("nova", status: "offline")));
    }
    ...
    public void TheGoodAndTheBadCanArriveTogether()
    {
        ...
        Assert.Equal(new[] { "nova", "kai" }, remotes.Select(r => r.Name));
    }
    ...
    public void AKnownColourIsAttached()
    {
        ...
        Assert.Equal("#ff0000", Assert.Single(Map(Agent("nova"))).Color);
    }
    ...
    public void AColourFromOneAccountDoesNotReachAnother()
    {
        ...
        Assert.Null(Assert.Single(Map(Agent("nova"))).Color);
    }
