...
var speakerCases = new (string Why, string? Identity, string? Title, string? Previous, string? Want)[]
{
    ...
    ("agent in a room",      "Aurora", "#openclaw-management", null, "Aurora"),
    ("agent, no title",      "Aurora", "",                     null, "Aurora"),
    ...
    ("identity list dropped", null,      "",                     "Aurora", "Aurora"),
    ("everything dropped",    null,      null,                   "Aurora", "Aurora"),
    ("blank over known",      "",        "   ",                  "Aurora", "Aurora"),

    // But a real change is a real change — a rebind to another session.
    ("rebound elsewhere",     "Alexis",  "#general",             "Aurora", "Alexis"),
